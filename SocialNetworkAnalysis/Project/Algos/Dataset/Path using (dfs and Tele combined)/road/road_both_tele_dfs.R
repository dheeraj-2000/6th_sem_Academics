...
plot(x_,y_,type="l",col="red", xlim=c(.9, 7.5), ylim = c(0.56, 1.01),  xlab="Number of steps taken",ylab="Cumulative fraction of instances", main = "Comparison of algorithms for Road network") + 
