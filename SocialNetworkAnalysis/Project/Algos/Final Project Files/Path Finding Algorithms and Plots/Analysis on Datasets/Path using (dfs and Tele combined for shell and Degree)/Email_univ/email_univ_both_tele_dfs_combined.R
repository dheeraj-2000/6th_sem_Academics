...
plot(degree_,y1,type="l",col="red", xlim=c(1, 60), ylim = c(0.0, 1.01),  xlab="Number of steps taken",ylab="Cumulative fraction of instances", main = "Comparison of algorithms for Email-Univ") + 
